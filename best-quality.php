...
<html>
    ...
    <body>
          ...
          <header>
            ...
            <div class="tv-inner-banner-image" style="background: rgba(0, 0, 0, 0) url('images/Image1.png') no-repeat scroll center top / cover;">
                ...
                <div class="tv-banner-title">
                    <h1>Best Quality Restaurants</h1>
                </div>
            </div>
            <!--End Banner Section-->
        </header>
        ...
        <a href="list-restaurants.php"><button type="button" class="btn btn-primary">All</button></a>
        <button type="submit" name='borough' value="Brooklyn" class="btn btn-primary">Brooklyn</button>
        <button type="submit" name='borough' value="Bronx" class="btn btn-primary">Bronx</button>
        <button type="submit" name='borough' value="Manhattan" class="btn btn-primary">Manhattan</button>
        <button type="submit" name='borough' value="Queens" class="btn btn-primary">Queens</button>
        <button type="submit" name='borough' value="Staten Island" class="btn btn-primary">Staten Islands</button>
        </form>
        </div>
        ...
        <?php 
            ...
            $cursor = $collection->aggregate([['$unwind' => ['path' => '$grades']], ['$project' => ['name' => 1, 'GT90' => ['$cond' => ['if' => ['$gt' => ['$grades.score', 90]], 'then' => true, 'else' => false]], 'grades' => 1, 'borough' => 1, 'cuisine' => 1, 'address'=>1]], ['$match' => ['GT90' => true]]]);
            //$cursor = $collection->aggregate([['$match' => ['grades' => ['$elemMatch' => ['score' => ['$gt' => 90]]]]]]);
